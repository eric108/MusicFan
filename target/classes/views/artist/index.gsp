<html lang="en">
  <head>
    ...
    <title>Search Results for ${artistName}</title>
	...
	<script type="text/javascript" src="${resource(dir:'js',file:'holder.js')}?color=FA8DFF">
	</script>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Results for ${artistName}</h1>
